...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected static function getEventDispatcherService($container)
    {
        ...
        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\LoginSuccessEvent', [#[\Closure(name: 'App\\Listener\\Security\\SecurityListener')] fn () => ($container->privates['App\\Listener\\Security\\SecurityListener'] ?? $container->load('getSecurityListenerService')), 'onLoginSuccess'], 0);
        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\LogoutEvent', [#[\Closure(name: 'App\\Listener\\Security\\SecurityListener')] fn () => ($container->privates['App\\Listener\\Security\\SecurityListener'] ?? $container->load('getSecurityListenerService')), 'onLogout'], 0);
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $b->allowControllers(['App\\Kernel', 'App\\Controller\\ClientController', 'App\\Controller\\InvoiceController', 'App\\Controller\\UserSecurityController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    protected static function getDebug_Security_Access_DecisionManagerService($container)
    {
        return $container->privates['debug.security.access.decision_manager'] = new \Symfony\Component\Security\Core\Authorization\TraceableAccessDecisionManager(new \Symfony\Component\Security\Core\Authorization\AccessDecisionManager(new RewindableGenerator(function () use ($container) {
            ...
            yield 3 => ($container->privates['.debug.security.voter.App\\Security\\Voter\\ClientVoter'] ?? $container->load('getClientVoterService'));
            yield 4 => ($container->privates['.debug.security.voter.App\\Security\\Voter\\InvoiceVoter'] ?? $container->load('getInvoiceVoterService'));
